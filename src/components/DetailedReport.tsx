...
Issue: ${ruleName}
Severity: ${severity} | WCAG: 2.2 ${wcag22Level || 'A'}
Date: ${currentDate}
    ...
    <div className="bg-white border border-gray-200 rounded-lg mb-4 max-w-full overflow-hidden">
        ...
        <div className="mb-4">
          ...
          {screenshots.viewport && (
            ...
            <img 
              ...
              className="w-full h-auto max-h-32 sm:max-h-36 md:max-h-40 object-cover cursor-pointer hover:opacity-90 transition-opacity rounded"
      ...
      <div>
        <h4 className="text-sm font-semibold text-gray-900 mb-2 flex items-center gap-2">
          ...
          AI-Generated Fixes ({suggestions.length} suggestions)
        </h4>
